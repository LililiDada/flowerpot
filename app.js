...
App({
  getRoomPage: function () {
    return this.getPage("pages/consult/consult")
  },
  getRoomPage2: function () {
    return this.getPage( 'pages/revert/revert')
  },
  getPage: function (pageName,pageName2) {
  ...
  onLaunch: function () {
    ...
    let clientID = '36e4c5372879f0c879ab'
    wx.BaaS.init(clientID)
  },
  globalData: {
    userInfo: null,
    hardwareUrl:'http://api.heclouds.com/',
    postUrl:'http://api.heclouds.com/',
    baseUrl:'http://47.101.35.149/flowerpot/public/index.php/',
    apikey:'Aupj49iyRUrG=cWeJ6PWKAlPhaI=',
    devIds:'',//设备ID
    variety:'',//设备表设备ID
  }
})